...
Future<void> showReservationOptionsDialog(
  BuildContext context,
  ValidReservation reservation, {
  required Future<void> Function(int webParkingId, String licensePlate)
      onArrival,
  required Future<void> Function(int webParkingId, String licensePlate) onLeave,
  ...
  final List<Widget> actionButtons = [
    ...
    if (reservation.state == 1 || reservation.state == 2)
      ElevatedButton(
        onPressed: () {
          Navigator.of(context).pop();
          onLeave(reservation.webParkingId, reservation.licensePlate);
        },
        style: ElevatedButton.styleFrom(
    ...
    if (reservation.state == 0)
      ElevatedButton(
        onPressed: () {
          Navigator.of(context).pop();
          onArrival(reservation.webParkingId, reservation.licensePlate);
        },
        style: ElevatedButton.styleFrom(
