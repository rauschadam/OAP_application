...
class NewReservationListPage extends StatefulWidget with PageWithTitle {
  @override
  ...
  const NewReservationListPage({super.key});

  @override
  State<NewReservationListPage> createState() => _NewReservationListPageState();
}

class _NewReservationListPageState extends State<NewReservationListPage> {
